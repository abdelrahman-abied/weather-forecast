...
class ForecastDetailsViewModelFactory(private val args: ForecastDetailsFragmentArgs) :
    ...
    override fun <T : ViewModel?> create(modelClass: Class<T>): T {
        if (modelClass.isAssignableFrom(ForecastDetialsViewModel::class.java)) {
            return ForecastDetialsViewModel(args) as T
        }
...
class ForecastDetialsViewModel(args: ForecastDetailsFragmentArgs) : ViewModel() {
